      ...
      return new Promise((resolve, reject) => {
        this.$http
          ...
          .then((res) => {
            ...
            console.log("--------------------- Amir Maghami ------------------------------");
            console.log("%cFile : " + `%c~/www/asrevira/portal-front/src/pages/Admin/Ticket/List.vue   `,"color: blue;","color: red;");
            console.log("%cLine : " + `%c225   `,"color: blue;","color: red;");
            console.log("%cType is : " + `%c${typeof this.tableData}   `,"color: blue;","color: red;");
            console.log("%cis Array: " + `%c${Array.isArray(this.tableData)} `,"color: blue;","color: red;");
            console.log("%cthis.tableData return  : " ,"color: blue;");
