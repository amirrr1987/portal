  ...
  >
    <template v-slot:top>
      <div style="background-color: #e9e9e9; position: relative">
        <CardTitle label="دسته بندی تخفیفات" color="#08b5dd"/>
        <v-btn color="#08b5dd" min-width="60" min-height="50" class="vira-discount-plus">
            <v-icon color="white" class=" font-lg-6">mdi-plus</v-icon>
        </v-btn>
        <v-row>
